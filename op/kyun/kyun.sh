...
Host='raw.githubusercontent.com/Demontisa/ML/main/op/kyun';export Host=$Host
...
echo
echo -n -e "请输入捕风阁网址：[\033[32m osuu.net\033[0m ]："
read key
if [[ $key == 'osuu.net' ]]
then
	echo
